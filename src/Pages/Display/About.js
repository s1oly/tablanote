...
const About = () =>{
    return(
        ...
        <p>
            ...
            Teentaal and Jhaptaal Compositions of one Awartan, however we look to expand on that on the future. If you have any questions, please email tablanote@gmail.com.
        </p>
        </div>
